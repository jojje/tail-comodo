## 
# Enable the parameter below to create a minimal build with from a custom 
# amalgation build of sqlite, having just the essential sqlite features needed. 
# Would only gain about 30% in binary size reduction for all the hazzle..
#
